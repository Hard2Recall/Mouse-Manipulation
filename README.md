...
`position.py` -   
When you start the program put your mouse cursor on possition of which you want to know coordinates and RGB value, then press ']' key to get those values. They will be printed out in the terminal.
...
`autoclickerV2.py` -   
when you start the program a small window will pop up that works as standard autoclicker terminal for quick configuration.

`pianotiles.py` -   
fun little script that automatically plays piano tiles game.  
...
`reactions.py` -   
this program is made to get best possible result in reaction game on humanbecnhmark.com  
Just open the website, run the code and alt+tab back to the website.

`Rf4Crafting.py` -   
this program is used in game called Russian Fishing 4 to automatically craft stuff so you dont have to spend 10mins clicking 2 of the same buttons.  
